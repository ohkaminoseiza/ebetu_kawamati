...
const SITE_PROJECTS = [
    {
        ...
        detail: '地元住民が毎日気持ちよく散歩やジョギングを楽しめるよう、河川沿いの遊歩道を整備するプロジェクトです。安全で快適な歩行空間の実現を目指しています。'
    },
    {
        id: 'shokusai',
        categoryId: 'chiiki-seibi',
        ...
        detail: '散歩道沿いに季節の花や樹木を植栽し、四季を感じられる緑豊かな歩行空間を作ります。花の種類の選定や植え付け作業に、ぜひご参加ください。また植樹記念プレート事業による桜並木の造成も検討中です。'
    },
    {
        id: 'bench',
        categoryId: 'chiiki-seibi',
        ...
        detail: '散歩道の要所に休憩用ベンチを設置するとともに、高齢者から子どもまで気軽に使える健康器具の配置を検討いたします。また桜並木と同様、記念プレート事業による設置資金の獲得を検討いたします。'
    },
    {
        id: 'sup',
    ...
    },
    {
        ...
        summary: '歴史的な倉庫を、地域の交流やイベントを生む新しい拠点として再生します。',
        detail: '長年使われていなかった旧岡田倉庫を、地域の新しい交流拠点として再生するプロジェクトです。地域の歴史的な建物を残しながら新たな賑わいを創出します。'
    },
    {
        id: 'okada-jukyo',
        categoryId: 'okada',
    ...
    },
    {
        ...
        summary: '桜並木や河川沿いの景観を発信し、地域の認知度と観光資源性を高めます。',
        detail: '地域の豊かな自然や緑化活動をSNS・パンフレット・映像で広く発信し、観光誘致につなげるプロジェクトです。桜並木や河川沿いの四季の景色を活かした情報発信を行い、地域の認知度向上を目指しています。'
    },
    {
        id: 'chiiki-event',
        categoryId: 'kanko-event',
